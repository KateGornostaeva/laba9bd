...
$db_user = 'std_1599_test'; //имя пользователя совпадает с именем БД
$db_password = 'qwerty'; //пароль, указаный при создании БД
$database = 'std_1599_test'; //имя БД, которое было указано при создании
